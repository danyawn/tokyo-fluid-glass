# 🌟 Tokyo Experience - Fluid Glass & Galaxy Web

> **An immersive Tokyo-themed website featuring fluid glass effects, galaxy backgrounds, and interactive 3D experiences built with modern web technologies.**
...
<div align="center">
  ...
  <p><em>Hero section with galaxy background and glitch text effects</em></p>
</div>

## 🚀 Features

### ✨ **Core Features**
- **🌌 Interactive Galaxy Background** - Dynamic starfield with mouse interaction and repulsion effects
...
- **OGL 1.0.11** - WebGL library for galaxy effects
...
│   │   │   ├── Galaxy.tsx              # Interactive galaxy background
│   │   │   └── ui/
...
- **Galaxy Background** - Interactive starfield with mouse repulsion
...
- **Galaxy Integration** - Seamless background integration
...
- **Galaxy Integration** - Seamless background continuation
...
### **Galaxy Background**
Modify `src/app/components/Galaxy.tsx` to adjust:
...
The galaxy background uses WebGL shaders to create a dynamic starfield with:
- **Mouse Repulsion** - Stars move away from cursor
- **Auto-rotation** - Continuous background movement
- **Twinkle Effects** - Stars pulse and flicker
- **Color Variations** - Multiple star colors and intensities
...
<div align="center">
  ...
  <p><em>Experience the future of web design with fluid glass and galaxy effects</em></p>
</div>
